...
Action buttons are specialized icon-only buttons used in headers and toolbars, featuring three distinct function types.

## Function Variants

- **Feature**: Brand-colored icon with subtle border (uses Semantic/Border/Subtle)
- **Action**: Neutral black tone with subtle border
...
Use the **Playground** to explore different icon combinations and sizes.`,
  ...
  argTypes: {
    ...
    function: {
      control: "radio",
      options: ["feature", "action", "close"],
      description: "Action button function variant",
    },
    iconName: {
      control: "select",
      options: iconOptions,
      description: "Lucide icon name (for feature/action only, close always uses X)",
